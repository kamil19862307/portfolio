...
@section('title', $title ?? 'Портфолио | Редактировать проект')
        ...
        <div class="flex flex-wrap">
            <div class="w-full lg:w-1/2 my-6 pr-0 lg:pr-2">
                <p class="text-xl pb-6 flex items-center">
                    <i class="fas fa-list mr-3"></i> Редактировать проекта
                </p>
                    ...
                    <form method="post" enctype="multipart/form-data" action="{{ route('admin.portfolio.update', $portfolio->id) }}"
                        ...
                        <div class="mt-2">
                            ...
                            <input class="w-full px-5 py-1 text-gray-700 @error('title') border-2 border-red-400 @enderror bg-gray-200 rounded"
                                   id="title" name="title" type="text" required="" value="{{ $portfolio->title }}"
